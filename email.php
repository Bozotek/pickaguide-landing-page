<?php
  ...
  try {
    ...
    $html = "Bonjour!<br/><br/>Nous avons le plaisir de vous informer que " . $from["firstname"] . " s'intéresse à vous et souhaite passer du temps à découvrir la ville avec vous !
      <br/>Prenez contact rapidement par mail sur " . $from["email"] . " ou sur son portable " . $from["tel"] . " !
